...
namespace Mjcheetham.PromptToolkit
{
    public class SystemConsole : IConsole
    {
        ...
        {
            Console.SetCursorPosition(CursorLeft, Math.Max(0, CursorTop - 1));
        }

        public void MoveCursorDown(int num = 1)
        {
            Console.SetCursorPosition(Math.Min(Console.WindowHeight, CursorTop + 1), CursorTop);
        }

        public void MoveCursorLeft(int num = 1)
        {
            Console.SetCursorPosition(Math.Max(0, CursorLeft - 1), CursorTop);
        }

        public void MoveCursorRight(int num = 1)
        {
            Console.SetCursorPosition(Math.Min(Console.WindowWidth, CursorLeft + 1), CursorTop);
        }
